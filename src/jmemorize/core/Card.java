...
public class Card implements Events, Cloneable
{
    ...
    /**
	 * @uml.property  name="m_level"
	 */
    private int      m_level;

    // content
    /**
	 * @uml.property  name="m_frontSide"
	 * @uml.associationEnd  
	 */
    private CardSide m_frontSide = new CardSide();
    /**
	 * @uml.property  name="m_backSide"
	 * @uml.associationEnd  
	 */
    ...
    // dates
    /**
	 * @uml.property  name="m_dateTested"
	 */
    private Date     m_dateTested;
    /**
	 * @uml.property  name="m_dateExpired"
	 */
    private Date     m_dateExpired;
    /**
	 * @uml.property  name="m_dateCreated"
	 */
    private Date     m_dateCreated;
    /**
	 * @uml.property  name="m_dateModified"
	 */
    private Date     m_dateModified;
    /**
	 * @uml.property  name="m_dateTouched"
	 */
    private Date     m_dateTouched; //this date is used internaly to order cards

    // stats
    /**
	 * @uml.property  name="m_testsTotal"
	 */
    private int      m_testsTotal;
    /**
	 * @uml.property  name="m_testsHit"
	 */
    private int      m_testsHit;    //succesfull learn repetitions
    /**
	 * @uml.property  name="m_frontHitsCorrect"
	 */
    private int      m_frontHitsCorrect;
    /**
	 * @uml.property  name="m_backHitsCorrect"
	 */
