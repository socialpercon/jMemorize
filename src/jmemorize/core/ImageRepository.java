...
public class ImageRepository
{
    ...
    /**
	 * @uml.property  name="m_imageMap"
	 * @uml.associationEnd  inverse="this$0:jmemorize.core.ImageRepository$ImageItem" qualifier="id:java.lang.String jmemorize.core.ImageRepository$ImageItem"
	 */
    private Map<String, ImageItem> m_imageMap    = new HashMap<String, ImageItem>();
    /**
	 * @uml.property  name="m_imageCache"
