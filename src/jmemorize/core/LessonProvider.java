...
/**
 * A lesson provider is responsible for handling loading and saving of lessons. You should always the methods of this class to load and save lessons, instead of using methods directly on the lesson objects. Note that there can always only be one lesson that is loaded. Loading another lesson will close the previous lesson, before loading the new one. Currently  {@link Main}  implements this interface.
 * @author  djemili
 */
public interface LessonProvider
{
    ...
    /**
	 * @return   currently loaded lesson. There can always only be at most one  lesson that is loaded. Returns <code>null</code> if there is no  currently loaded lesson.
	 * @uml.property  name="lesson"
	 * @uml.associationEnd  
	 */
	 ...
	 * @uml.property  name="recentLessonFiles"
	 * @uml.associationEnd  
	 */
