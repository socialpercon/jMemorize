...
public class Category implements Events
{
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.CategoryObserver"
	 */
    private List<CategoryObserver> m_observers       = new ArrayList<CategoryObserver>();

    /**
	 * @uml.property  name="m_name"
	 */
    private String                 m_name;
    /**
	 * @uml.property  name="m_depth"
	 */
    private int                    m_depth           = 0;                     // is 0 for root category

    /**
	 * @uml.property  name="m_decks"
	 * @uml.associationEnd  
	 */
	 ...
	 * @uml.associationEnd  inverse="m_childCategories:jmemorize.core.Category"
	 */
    private Category               m_parent;
    /**
	 * @uml.property  name="m_childCategories"
	 * @uml.associationEnd  multiplicity="(0 -1)" inverse="m_parent:jmemorize.core.Category"
	 */
