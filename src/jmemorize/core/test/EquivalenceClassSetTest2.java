...
public class EquivalenceClassSetTest2 extends TestCase
{
    ...
    /**
	 * @uml.property  name="intWrapEqvSet"
	 * @uml.associationEnd  
	 */
    private EquivalenceClassSet intWrapEqvSet;
    /**
	 * @uml.property  name="iwHandles"
	 * @uml.associationEnd  multiplicity="(0 -1)" inverse="this$0:jmemorize.core.test.EquivalenceClassSetTest2$IntWrapper"
	 */
