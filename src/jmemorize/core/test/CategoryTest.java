...
public class CategoryTest extends TestCase implements CategoryObserver
{
    ...
    /**
	 * @uml.property  name="m_childCategory"
	 * @uml.associationEnd  
	 */
    private Category        m_childCategory;

    /**
	 * @uml.property  name="m_rootCard"
	 * @uml.associationEnd  
	 */
    private Card            m_rootCard;
    /**
	 * @uml.property  name="m_childCard"
	 * @uml.associationEnd  
	 */
    private Card            m_childCard;

    /**
	 * @uml.property  name="m_events"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.test.CategoryTest$TestEvent"
	 */
