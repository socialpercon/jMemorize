...
public class LearnSettings
{
	 ...
	 */
    LINEAR, /**
	 * @uml.property  name="qUAD"
	 * @uml.associationEnd  
	 */
    QUAD, /**
	 * @uml.property  name="eXPONENTIAL"
	 * @uml.associationEnd  
	 */
    EXPONENTIAL, /**
	 * @uml.property  name="cRAM"
	 * @uml.associationEnd  
	 */
    CRAM, /**
	 * @uml.property  name="cUSTOM"
	 * @uml.associationEnd  
	 */
    CUSTOM}
    ...
    /**
	 * @uml.property  name="m_amountToTestFront"
	 */
    private int                  m_amountToTestFront   = 1;
    /**
	 * @uml.property  name="m_amountToTestBack"
	 */
    private int                  m_amountToTestBack    = 1;

    /**
	 * @uml.property  name="m_schedulePreset"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private SchedulePreset       m_schedulePreset;
    /**
	 * @uml.property  name="m_schedule" multiplicity="(0 -1)" dimension="1"
	 */
    private int[]                m_schedule;
    
    /**
	 * @uml.property  name="m_fixedExpirationTimeEnabled"
	 */
    private boolean              m_fixedExpirationTimeEnabled;
    /**
	 * @uml.property  name="m_fixedExpirationHour"
	 */
    private int                  m_fixedExpirationHour;
    /**
	 * @uml.property  name="m_fixedExpirationMinute"
	 */
    private int                  m_fixedExpirationMinute;
    
    /**
	 * @uml.property  name="m_limitTime"
	 */
    private int                  m_limitTime;
    /**
	 * @uml.property  name="m_retestFailedCards"
	 */
    private boolean              m_retestFailedCards;
    /**
	 * @uml.property  name="m_sides"
	 */
    private int                  m_sides;
    /**
	 * @uml.property  name="m_groupByCategory"
	 */
    private boolean              m_groupByCategory;
    /**
	 * @uml.property  name="m_categoryOrder"
	 */
    private int                  m_categoryOrder;
    /**
	 * @uml.property  name="m_shuffleRatio"
	 */
    private float                m_shuffleRatio;

    /**
	 * @uml.property  name="m_limitCardsEnabled"
	 */
    private boolean              m_limitCardsEnabled;
    /**
	 * @uml.property  name="m_limitTimeEnabled"
	 */
    private boolean              m_limitTimeEnabled;
    /**
	 * @uml.property  name="m_limitCards"
	 */
