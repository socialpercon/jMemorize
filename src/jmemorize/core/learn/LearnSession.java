...
/**
 * A LearnSession is where the learning actually happens. It should be instantiated with a LearnSettings object that defines how the session should  work. See  {@link DefaultLearnSession}  for the default implementation.
 * @author  djemili
 */
public interface LearnSession
{
    ...
    /**
	 * @return  the date this session ended or <code>null</code> if it hasn't  ended yet.
