...
//            return (date0.before(date1) ? -1 : 1);
    ...
    /**
	 * This class is a wrapper for a card. It allows to associate additional data to a card, that is only relevant during a single specifc learn session.
	 */
    private class CardInfo
    {
        /**
		 * @uml.property  name="m_card"
		 * @uml.associationEnd  
		 */
        private Card m_card;
    ...
    /**
	 * @uml.property  name="m_rootCategory"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    ...
    /**
	 * @uml.property  name="m_quit"
	 */
    private boolean                        m_quit;
    /**
	 * @uml.property  name="m_learningStarted"
	 */
    private boolean                        m_learningStarted = false;
    /**
	 * @uml.property  name="m_currentCardInfo"
	 * @uml.associationEnd  inverse="this$0:jmemorize.core.learn.DefaultLearnSession$CardInfo"
	 */
    ...
    /**
	 * @uml.property  name="m_cardsActive"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private EquivalenceClassSet<CardInfo>  m_cardsActive;
    /**
	 * @uml.property  name="m_cardsReserve"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    ...
    /**
	 * @uml.property  name="m_cardsChecked"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.Card"
	 */
    private List<Card>                     m_cardsChecked = new ArrayList<Card>();
    /**
	 * @uml.property  name="m_cardsLearned"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.Card"
	 */
    private Set<Card>                      m_cardsLearned = new HashSet<Card>();
    /**
	 * @uml.property  name="m_cardsInfoMap"
	 * @uml.associationEnd  qualifier="card:jmemorize.core.Card jmemorize.core.learn.DefaultLearnSession$CardInfo"
	 */
    ...
    /**
	 * @uml.property  name="m_cardsEverFailed"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.Card"
	 */
    private Set<Card>            m_cardsEverFailed  = new HashSet<Card>();
    /**
	 * @uml.property  name="m_cardsSkipped"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.Card"
	 */
    ...
    /**
	 * @uml.property  name="m_cardsActivePartiallyLearned"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.Card"
	 */
    ...
    // etc
    /**
	 * @uml.property  name="m_rand"
	 */
    private Random               m_rand             = new Random();
    /**
	 * @uml.property  name="m_cardObservers"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.learn.LearnSession$LearnCardObserver"
	 */
    private List<LearnCardObserver> m_cardObservers = new LinkedList<LearnCardObserver>();

    /**
	 * @uml.property  name="m_start"
	 */
    private Date                 m_start;
    /**
	 * @uml.property  name="m_end"
	 */
    private Date                 m_end;
    
    /**
	 * @uml.property  name="m_logger"
	 */
