...
public class LearnHistory
{
    ...
    /**
	 * @uml.property  name="m_summaries"
	 * @uml.associationEnd  multiplicity="(0 -1)" inverse="this$0:jmemorize.core.learn.LearnHistory$SessionSummary"
	 */
    private List<SessionSummary>    m_summaries = new ArrayList<SessionSummary>();
    
    /**
	 * @uml.property  name="m_file"
	 */
    private File                    m_file;
    /**
	 * @uml.property  name="m_isLoaded"
	 */
