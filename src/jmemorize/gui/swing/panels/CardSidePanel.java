...
public class CardSidePanel extends JPanel
{
	 ...
	 */
    IMAGE, /**
	 * @uml.property  name="tEXT_AND_IMAGE"
	 * @uml.associationEnd  
	 */
    TEXT_AND_IMAGE};
    
    /**
	 * @uml.property  name="m_contentPanel"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JPanel                  m_contentPanel;
    /**
	 * @uml.property  name="m_imageBar"
	 * @uml.associationEnd  
	 */
    private JToolBar                m_imageBar;
    /**
	 * @uml.property  name="m_imageLabel"
	 * @uml.associationEnd  
	 */
    private JLabel                  m_imageLabel;

    /**
	 * @uml.property  name="m_textPane"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JTextPane               m_textPane       = new JTextPane();
    /**
	 * @uml.property  name="m_textScrollPane"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JScrollPane             m_textScrollPane = new JScrollPane(m_textPane);
    /**
	 * @uml.property  name="m_imagePanel"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:jmemorize.gui.swing.panels.CardSidePanel$ScaledImagePanel"
	 */
    private ScaledImagePanel        m_imagePanel     = new ScaledImagePanel();

    /**
	 * @uml.property  name="m_images"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="javax.swing.ImageIcon"
	 */
    private List<ImageIcon>         m_images         = new LinkedList<ImageIcon>();
    /**
	 * @uml.property  name="m_currentImage"
	 */
    ...
    private Mode                    m_mode;
    /**
	 * @uml.property  name="m_imageObservers"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.gui.swing.panels.CardSidePanel$CardImageObserver"
	 */
    private List<CardImageObserver> m_imageObservers = new LinkedList<CardImageObserver>();
    /**
	 * @uml.property  name="m_cardFont"
	 * @uml.associationEnd  
	 */
    private CardFont                m_cardFont;

    /**
	 * @uml.property  name="m_prevImageButton"
	 * @uml.associationEnd  
	 */
    private JButton                 m_prevImageButton;
    /**
	 * @uml.property  name="m_nextImageButton"
	 * @uml.associationEnd  
	 */
    private JButton                 m_nextImageButton;

    /**
	 * @uml.property  name="m_textModeButton"
	 * @uml.associationEnd  
	 */
    private JButton                 m_textModeButton;
    /**
	 * @uml.property  name="m_imageModeButton"
	 * @uml.associationEnd  
	 */
    private JButton                 m_imageModeButton;
    /**
	 * @uml.property  name="m_imageTexModeButton"
	 * @uml.associationEnd  
	 */
