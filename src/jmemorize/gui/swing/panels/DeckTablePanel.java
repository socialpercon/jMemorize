...
public class DeckTablePanel extends JPanel implements CategoryObserver
{
    ...
    /**
	 * @uml.property  name="m_nextDeckAction"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:jmemorize.gui.swing.panels.DeckTablePanel$NextDeckAction"
	 */
    private NextDeckAction     m_nextDeckAction     = new NextDeckAction();
    /**
	 * @uml.property  name="m_previousDeckAction"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:jmemorize.gui.swing.panels.DeckTablePanel$PreviousDeckAction"
	 */
    private PreviousDeckAction m_previousDeckAction = new PreviousDeckAction();
    
    /**
	 * @uml.property  name="m_currentDeckLevel"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="m_deckTablePanel:jmemorize.gui.swing.frames.MainFrame"
	 */
    private MainFrame          m_frame;
    
    // swing elements
    /**
	 * @uml.property  name="m_cardTable"
