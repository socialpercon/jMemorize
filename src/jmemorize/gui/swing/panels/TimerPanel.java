...
public class TimerPanel extends JPanel implements ActionListener
{
    ...
    /**
	 * @uml.property  name="m_formater"
	 */
    private DecimalFormat m_formater  = new DecimalFormat("##00"); //$NON-NLS-1$

    /**
	 * @uml.property  name="m_secondsPassed"
	 */
    private int           m_secondsPassed;
    /**
	 * @uml.property  name="m_secondsTarget"
	 */
    private int           m_secondsTarget;

    /**
	 * @uml.property  name="m_timer"
	 * @uml.associationEnd  
	 */
    ...
    /**
	 * @uml.property  name="m_learnSession"
	 * @uml.associationEnd  
	 */
