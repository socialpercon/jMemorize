...
public class CardCounterPanel extends JPanel
{
    ...
    /**
	 * @uml.property  name="m_cardsPassed"
	 */
    private int                m_cardsPassed;
    /**
	 * @uml.property  name="m_cardsPartiallyPassed"
	 */
    private int                m_cardsPartiallyPassed;
    /**
	 * @uml.property  name="m_cardsTarget"
	 */
    private int                m_cardsTarget;
    /**
	 * @uml.property  name="m_showPartiallyPassed"
	 */
    ...
    /**
	 * @uml.property  name="m_pieDataset"
	 * @uml.associationEnd  
	 */
    private DefaultPieDataset  m_pieDataset;
    /**
	 * @uml.property  name="m_bar"
	 * @uml.associationEnd  
	 */
    private JProgressBar       m_bar;
    /**
	 * @uml.property  name="m_textField"
