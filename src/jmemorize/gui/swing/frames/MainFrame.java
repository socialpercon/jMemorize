    ...
    SelectionProvider, SelectionObserver, LearnSessionObserver, ProgramEndObserver
{
    ...
    /**
	 * @uml.property  name="m_categoryBox"
	 * @uml.associationEnd  
	 */
    private CategoryComboBox                m_categoryBox;
    /**
	 * @uml.property  name="m_categoryTree"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private CategoryTree                    m_categoryTree;
    /**
	 * @uml.property  name="m_deckTablePanel"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="m_frame:jmemorize.gui.swing.panels.DeckTablePanel"
	 */
    private DeckTablePanel                  m_deckTablePanel;
    /**
	 * @uml.property  name="m_deckChartPanel"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="m_frame:jmemorize.gui.swing.panels.DeckChartPanel"
	 */
    private DeckChartPanel                  m_deckChartPanel;
    /**
	 * @uml.property  name="m_learnPanel"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private LearnPanel                      m_learnPanel;
    /**
	 * @uml.property  name="m_statusBar"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private StatusBar                       m_statusBar          = new StatusBar();
    /**
	 * @uml.property  name="m_newCardManager"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    ...
    /**
	 * @uml.property  name="m_bottomPanel"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JPanel                          m_bottomPanel;
    /**
	 * @uml.property  name="m_showTreeButton"
	 * @uml.associationEnd  
	 */
    private JButton                         m_showTreeButton;
    /**
	 * @uml.property  name="m_horizontalSplitPane"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JSplitPane                      m_horizontalSplitPane;
    /**
	 * @uml.property  name="m_verticalSplitPane"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JSplitPane                      m_verticalSplitPane;
    /**
	 * @uml.property  name="m_treeScrollPane"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JScrollPane                     m_treeScrollPane;

    /**
	 * @uml.property  name="m_main"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="m_frame:jmemorize.core.Main"
	 */
    private Main                            m_main;
    /**
    ...
    /**
	 * @uml.property  name="m_deck"
	 */
    private int                             m_deck;
    /**
	 * @uml.property  name="m_selectionObservers"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.gui.swing.SelectionProvider$SelectionObserver"
	 */
    private List<SelectionObserver>         m_selectionObservers = new LinkedList<SelectionObserver>();

    // category tree
    /**
	 * @uml.property  name="m_showCategoryTree"
	 */
    private boolean                         m_showCategoryTree;
    /**
	 * @uml.property  name="m_showCategoryTreeOld"
	 */
    private boolean                         m_showCategoryTreeOld;
    
    /**
	 * @uml.property  name="m_categoryTreeWidth"
	 */
    ...
    // UGLYHACK remove
    /**
	 * @uml.property  name="m_focusedCategories"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.core.Category"
	 */
