...
public class NewCardFrame extends EscapableFrame 
{
    ...
    // swing elements
    /**
	 * @uml.property  name="m_manager"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="m_newCardFrames:jmemorize.gui.swing.NewCardFramesManager"
	 */
    ...
    /**
	 * @uml.property  name="m_createMoreButton"
	 * @uml.associationEnd  
	 */
    private JButton              m_createMoreButton;
    /**
	 * @uml.property  name="m_editRecentAction"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
