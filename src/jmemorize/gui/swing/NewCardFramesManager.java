...
public class NewCardFramesManager implements LessonObserver, CategoryObserver
{
    ...
    /**
	 * @uml.property  name="m_newCardFrames"
	 * @uml.associationEnd  multiplicity="(0 -1)" inverse="m_manager:jmemorize.gui.swing.frames.NewCardFrame"
	 */
    private List<NewCardFrame>  m_newCardFrames = new LinkedList<NewCardFrame>();
    /**
	 * @uml.property  name="m_createdCards"
