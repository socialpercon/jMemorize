...
public class GeneralTransferHandler extends TransferHandler
{
    ...
    /**
	 * Represents a formatted text and it source document. We need the source  for CUT-operations where we need to remove the formatted section from  the original document.
	 */
    public class FormattedTextSection
    {
        /**
		 * @uml.property  name="m_text"
		 * @uml.associationEnd  
		 */
    ...
    {
        /**
		 * @uml.property  name="m_formattedText"
		 * @uml.associationEnd  
		 */
    ...
    /**
	 * @uml.property  name="m_cardSidePanel"
	 * @uml.associationEnd  
	 */
