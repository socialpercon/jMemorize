...
/**
 * A simple interface that provides a card context. What a selection is depends on the context. In most cases you should only declare cards and categories as selected if they were activily selected by the user (i.e. by clicking with the mouse). Sometimes there are also implicit selections though. For example while learning the currently learned card is always considered as selected. If there are cards selected there should never also be categories selected and vice-versa.
 * @author  djemili
 */
public interface SelectionProvider
{
	 ...
	 * @uml.property  name="defaultFocusOwner"
	 * @uml.associationEnd  
	 */
