...
{
    /**
	 * @uml.property  name="m_okayButton"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JButton     m_okayButton = new JButton();
    /**
	 * @uml.property  name="m_moreButton"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JButton     m_moreButton = new JButton();
    /**
	 * @uml.property  name="m_copyButton"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JButton     m_copyButton = new JButton();

    /**
	 * @uml.property  name="m_exception"
	 */
    private Exception   m_exception;
    /**
	 * @uml.property  name="m_stacktraceArea"
	 * @uml.associationEnd  
	 */
    private JTextArea   m_stacktraceArea;
    /**
	 * @uml.property  name="m_scrollPane"
	 * @uml.associationEnd  
	 */
    private JScrollPane m_scrollPane;
    /**
	 * @uml.property  name="m_extended"
	 */
    private boolean     m_extended   = false;

    /**
	 * @uml.property  name="m_message"
	 */
    private String      m_message;
    /**
	 * @uml.property  name="m_debugText"
	 */
    private String      m_debugText;
    /**
	 * @uml.property  name="m_placeholderPanel"
	 * @uml.associationEnd  
	 */
