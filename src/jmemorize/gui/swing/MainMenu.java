...
import jmemorize.gui.swing.actions.Actions;
...
import jmemorize.gui.swing.actions.file.ExportToSQLAction;
import jmemorize.gui.swing.actions.file.ImportCSVAction;
import jmemorize.gui.swing.actions.file.ImportJMLAction;
import jmemorize.gui.swing.actions.file.ImportSQLAction;//DB기능 추가
...
{
    /**
	 * @uml.property  name="m_fileMenu"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JMenu                       m_fileMenu;
    //JMenuItem importSQL = new JMenuItem("데이터베이스 가져오기");
    ...
    private JMenu buildSqlMenu()
    {
        JMenu sqlMenu = new JMenu("Connection");
        add(sqlMenu);
        sqlMenu.add(Actions.CONNECT);
        //sqlMenu.add(Actions.DISCONNECT);
        sqlMenu.addSeparator();
        //sqlMenu.add(Actions.COMMIT);
        //sqlMenu.add(Actions.ROLLBACK);
        //sqlMenu.addSeparator();
        sqlMenu.add(new JMenuItem("Clean"));
        //setMnemonics(this);
        return sqlMenu;
    }
/*    private void setMnemonics(MenuElement menuElement) {
    ...
    private JMenu buildHelpMenu()
    {
        ...
        menu.add(new JMenuItem(new OpenURLAction(
            ...
            "http://blog.naver.com/sealriel" //$NON-NLS-1$
        )));
    ...
    private void buildFileMenu()
    {
        ...
        importMenu.add(new ImportSQLAction());
        ...
        exportMenu.setIcon(new ImageIcon(
            getClass().getResource("/resource/icons/blank.gif"))); //$NON-NLS-1$
        exportMenu.add(new ExportToSQLAction());
