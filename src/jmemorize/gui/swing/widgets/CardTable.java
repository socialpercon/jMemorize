...
{
    /**
	 * A TableCellRenderer that displays card sides. It uses the specified fonts for front/flip sides.
	 */
    ...
    // icons
    /**
	 * @uml.property  name="m_ascendingArrow"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private Icon                  m_ascendingArrow  = new Arrow(false, 17);
    /**
	 * @uml.property  name="m_descendingArrow"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	 ...
	 * @uml.property  name="m_highlight"
	 */
    private Color                 m_highlight       = new Color(0xF4, 0xF4, 0xF3);
    
    /**
	 * @uml.property  name="m_tableModel"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:jmemorize.gui.swing.widgets.CardTable$ViewModel"
	 */
    private ViewModel             m_tableModel      = new ViewModel();
    /**
	 * @uml.property  name="m_columns" multiplicity="(0 -1)" dimension="1"
	 */
    private int[]                 m_columns;
    /**
	 * @uml.property  name="m_defaultColumns" multiplicity="(0 -1)" dimension="1"
	 */
    private int[]                 m_defaultColumns;
    /**
	 * @uml.property  name="m_columnWidths" multiplicity="(0 -1)" dimension="1"
	 */
    private int[]                 m_columnWidths    = new int[COLUMN_NAMES.length];
    /**
	 * @uml.property  name="m_frontSideFont"
	 * @uml.associationEnd  
	 */
    private CardFont              m_frontSideFont;
    /**
	 * @uml.property  name="m_flipSideFont"
	 * @uml.associationEnd  
	 */
    private CardFont              m_flipSideFont;
    /**
	 * @uml.property  name="m_prefs"
	 */
    private Preferences           m_prefs;
    /**
	 * @uml.property  name="m_minTableRowHeight"
	 */
    ...
    /**
	 * @uml.property  name="m_selectionListeners"
