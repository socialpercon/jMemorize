...
public class CategoryTree extends JTree implements CategoryObserver, SelectionProvider
{
    ...
    {
        /**
		 * @uml.property  name="m_editedCategory"
		 * @uml.associationEnd  
		 */
	 ...
	 * @uml.property  name="m_beforeMenuCategory"
	 * @uml.associationEnd  
	 */
    ...
    /**
	 * @uml.property  name="m_categoryMenu"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private JPopupMenu              m_categoryMenu;
    /**
	 * @uml.property  name="m_reopeningCategoryMenu"
	 */
