...
public class RecentItems
{
    ...
    /**
	 * @uml.property  name="m_maxItems"
	 */
    private int                       m_maxItems;
    /**
	 * @uml.property  name="m_prefNode"
	 */
    private Preferences               m_prefNode;

    /**
	 * @uml.property  name="m_items"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="java.lang.String"
	 */
    private List<String>              m_items            = new ArrayList<String>();
    /**
	 * @uml.property  name="m_observers"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="jmemorize.util.RecentItems$RecentItemsObserver"
	 */
