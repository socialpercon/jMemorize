...
public class EquivalenceClassSet<T> extends AbstractSet<T> 
{
    ...
    /**
	 * @uml.property  name="m_equivalenceClasses"
	 * @uml.associationEnd  readOnly="true" multiplicity="(1 -1)" elementType="java.util.List"
	 */
    private List                m_equivalenceClasses;
    /**
	 * @uml.property  name="m_size"
	 */
    private int                 m_size; // cached for efficiency
    /**
	 * @uml.property  name="m_comparator"
	 */
    private Comparator          m_comparator;
    /**
	 * @uml.property  name="m_loopEqvClassIter"
    ...
    /**
	 * @uml.property  name="m_loopCurrentEqvClass"
	 */
    private List                m_loopCurrentEqvClass; // ptr to current class, null ok
    /**
	 * @uml.property  name="m_loopItemIter"
	 */
    ...
    // objects.
    /**
	 * @uml.property  name="m_itemToClassMap"
	 * @uml.associationEnd  qualifier="arg0:java.lang.Object java.util.List"
	 */
